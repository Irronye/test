...
def BDD100K_pretrain_rcrop(mean=None, std=None):
    trans_list = [
...
def BDD100K_pretrain_ccrop(alpha=0.6, mean=None, std=None):
    trans_list = [
...
def BDD100K_linear_train(mean=None, std=None):
...
def BDD100K_val(mean=None, std=None):
    trans = transforms.Compose([
...
def BDD100K_eval_boxes(mean=None, std=None):
    trans = transforms.Compose([
...
def BDD100K_supervised_train(normalize):
    trans = transforms.Compose([
        transforms.RandomResizedCrop(size=224),
